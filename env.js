 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.r34.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'app.r34'; // ios bundle id
const PACKAGE = 'app.r34'; // android package name
const NAME = 'r34'; // app name
const SCHEME = 'r34'; // app scheme
